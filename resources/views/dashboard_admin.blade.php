...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-light fixed-top">
    <div class="container">
        <img src="{{url('/assets/images/logo/Inferno_Type_whi.png')}}" alt="" style="width:15%">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="#">Pemagang</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row h-100 align-items-center">
        <div class="col-lg-12">
            <center>
                    ...
                    <p class="subtitle">Selamat Datang di Halaman Admin</p>
                    <a href="/signup" type="button" class="btn btn-logout">Pemagang</a>
                    <a href="/signup" type="button" class="btn btn-logout">Perusahaan</a>
            </center>
        </div>
      </div>
    </div>
